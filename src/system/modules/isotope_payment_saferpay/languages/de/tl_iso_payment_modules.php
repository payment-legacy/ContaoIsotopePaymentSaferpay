...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payment_saferpay_disable_ssl_verification']	= array('Saferpay SSL Prüfung Deaktivieren (falls es nicht funktioniert)', 'Deaktiviert die SSL Prüfung');
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payment_saferpay_timeout']					= array('Saferpay Request Timeout', 'in Milisekunden');
...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payment_saferpay_providerset_billpay']		= array('Saferpay Billpay Zahlungart', 'Übergeben Sie Saferpay, welche Zahlungsarten (Billpay) sie nutzen wollen. Wählen Sie nur jene, welche in ihrem Saferpaykonto freigeschaltet sind.');
